        ...
        <div>
            <div className="section row" style={{
                ...
                <div className="container introSection col s12">
                    ...
                    <Floating />
                    <h2 className="header col s12 l6 center newchatTitle">newchat</h2>
                ...
                <div className="section no-pad-bot">
                    <div className="container">
                        ...
                        <div className="row center">
                            <h5 className="header white-text col s12 light">Learn how you can switch things up with newchat.</h5>
                        </div>
                        <div className="row center">
