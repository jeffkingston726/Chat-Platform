...
const ChatBotUI = (props) => {
    ...
    const divTemplate = (msg) => {
        ...
        h4.innerText = "newchat assistant";
    ...
    return (
        ...
        <div className="slider-wrap">
            <div id="card-slider" className="slider">
                <div className="slider-item">
                    ...
                    <div className="animation-card_content">
                        <h4 className="animation-card_content_title title-2">newchat assistant</h4>
                        <p className="animation-card_content_description p-2">Hello, I'm your newchat assistant</p>
            ...
            <div className="input-field col s6" style={{position: "fixed", bottom: "60px", left: "40px", margin: 0, 
                ...
                />
                <label htmlFor="user_query" style={{margin:"0"}}>Ask your newchat assistant...</label>
            </div>
            </div>   
        </div>
    )
