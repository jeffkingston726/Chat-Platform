            ...
            setOptions() {
                ...
                this.slideData = {
                    0: {
                        image: Acc,
                        title: 'Account',
                        description: `Name: adamvenord17<br/>Email: adamvenord17@gmail.com`
                    },
                    1: {
                        image: Usage,
                        title: 'Usage',
                        description: `Track your usage, activity and your favourite pals based on<br/>the frequency! This part of the site is more of a statistical<br/>part and lets you have an overview of your whole activity on<br/>newchat.
                        <br/><br/>
                    ...
                    2: {
                        image: about,
                        title: 'newchat',
                        description: `newchat. The very thing you're seeing right now, is an <br/>online-web-chatting platform with a few multiplayer <br/>games integrated into it. It has a chat-bot which <br/>can do a lot of your fancy stuffs including hosting a<br/>listening party. Let's vibe together, shall we?.`
                    }
                }
                ...
                <button className="expand">
                    ...
                    <article>
                        ...
                        <div className="description">
                            <p className="next"></p>
                            <p className="current">
                                Name: adamvenord17<br/>Email: adamvenord17@gmail.com    
                            </p>
                        </div>
