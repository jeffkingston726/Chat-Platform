            ...
            <div className="row">
              <div className="col l6 s12">
                ...
                <p className="grey-text text-lighten-4">
                    A project by <a href="https://github.com/adamvenord17" className="attribute">
                        adamvenord17
                    </a>
                </p>
                <p id="twitter-embed">
                  <a href="https://twitter.com/adamvenord17?ref_src=twsrc%5Etfw" className="twitter-follow-button" data-show-count="false">Follow @adamvenord17</a>
                </p>
              </div>
              <div className="col l4 offset-l2 s12">
                ...
                <ul className="col s12">
                  <li id="github-embed" className="col s12">
                    ...
                    data-github="adamvenord17" data-height="215px" data-width="300px" data-theme="medium">
                    </div>
                  </li>
                  <li>
                    <a href="https://github.com/adamvenord17" target="__blank">
                      <div className="chip">
